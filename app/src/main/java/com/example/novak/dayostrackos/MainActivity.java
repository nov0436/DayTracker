...
public class MainActivity extends AppCompatActivity
    ...
    TextView welcomeTextView, phraseTextView;
    ...
    protected void onResume() {
        ...
        if (name.equals("")) {
            ...
            welcomeTextView.setText(getResources().getString(R.string.welcome_back) + " " + name + " !");
        }

        if (phrase.equals("")) {
            phraseTextView.setText(getResources().getString(R.string.main_customize_subtitle));
        } else {
